...
function getNowPlayingBarHtml() {
    ...
    html += '<input type="range" is="emby-slider" pin step="1" min="0" max="150" value="0" class="slider-medium-thumb nowPlayingBarVolumeSlider"/>';
    html += '</div>';
...
function updatePlayerVolumeState(isMuted, volumeLevel) {
    ...
    if (volumeSlider) {
        ...
        volumeSlider.setAttribute('max', maxVolume);
